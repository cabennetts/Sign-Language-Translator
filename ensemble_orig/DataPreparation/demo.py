...
from DataPreparation.pose_hrnet import get_pose_net
# import coremltools as ct
from collections import OrderedDict
from DataPreparation.config import cfg
from DataPreparation.config import update_config

from PIL import Image
import numpy as np
import cv2

from DataPreparation.utils import pose_process, plot_pose
...
def run(input_videos = None, output_path = None):
    with torch.no_grad():
        config = 'C:/Users/Alex Anderson/Documents/EECS_581/ensemble/DataPreparation/wholebody_w48_384x288.yaml'
        ...
        checkpoint = torch.load('C:/Users/Alex Anderson/Documents/EECS_581/ensemble/DataPreparation/hrnet_w48_coco_wholebody_384x288-6e061c6a_20200922.pth')
        ...
        for i, path in enumerate(paths):
            ...
            if output_path is None:
                print("Setting output to: " + 'D:/npy/Test/{}.npy'.format(names[i]))
                output_npy = 'D:/npy/Test/{}.npy'.format(names[i])
            else:
                print("Setting output to: " + output_path + '/{}.npy'.format(names[i]))
