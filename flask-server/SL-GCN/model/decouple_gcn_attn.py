...
class TCN_GCN_unit(nn.Module):
    def __init__(self, in_channels, out_channels, A, groups, num_point, block_size, stride=1, residual=True, attention=False):
...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, groups=8, block_size=41, graph=None, graph_args=dict(), in_channels=3):
        ...
        self.l3 = TCN_GCN_unit(64, 128, A, groups, num_point, block_size)
        # self.l4 is a dropout layer
        ...
        self.l5 = TCN_GCN_unit(128, 128, A, groups, num_point, block_size)
        #self.l7 = TCN_GCN_unit(128, 128, A, groups, num_point, block_size)
        self.l6 = TCN_GCN_unit(128, 256, A, groups,
                               num_point, block_size, stride=2)
        self.l7 = nn.Dropout(0.5)
        #self.l9 = TCN_GCN_unit(256, 256, A, groups, num_point, block_size)
        self.l8 = TCN_GCN_unit(256, 256, A, groups, num_point, block_size)
