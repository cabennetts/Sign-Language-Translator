...
from utils import plot_pose, pose_process
...
def run(input_videos = None, output_path = None):
    with torch.no_grad():
        config = '/Users/cabennetts/Documents/GitHub/Sign-Language-Translator/flask-server/DataPreparation/wholebody_w48_384x288.yaml'
        ...
        checkpoint = torch.load('/Users/cabennetts/Documents/GitHub/Sign-Language-Translator/flask-server/DataPreparation/hrnet_w48_coco_wholebody_384x288-6e061c6a_20200922.pth')
        ...
        for i, path in enumerate(paths):
            ...
            while cap.isOpened():
                ...
                for scale in multi_scales:
                    ...
                    img_temp = norm_numpy_totensor(img_temp)
                    print(img_temp.size())
